...
import PetModel
    from 'Frontend/generated/com/wornux/features/pet/domain/PetModel'
...
const ActiveRenderer: React.FC<{ item: PetModel }> = ({item}) => {
    ...
    return (<span
        style={{
            color: isActive ? '#16a34a' : '#dc2626', fontWeight: 'bold',
        }}
    >
...
export const config: ViewConfig = {
    menu: {title: 'Ver'}, title: 'Lista de Mascotas',
}

export default function PetListView() {
    return (<main className="w-full h-full flex flex-col box-border gap-s p-m">
        <AutoGrid
            service={{
                ...PetServiceImpl, list: async (pageable, filter) => {
