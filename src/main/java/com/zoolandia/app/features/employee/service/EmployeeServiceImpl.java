...
public class EmployeeServiceImpl extends ListRepositoryService<Employee, Long, EmployeeRepository>
  ...
  /**
   * Searches for employees based on a search term. This method can be accessed by any authenticated
   * user.
   *
  ...
  /**
   * Retrieves all available veterinarians for emergency services. This method can be accessed by
  ...
  /**
   * Updates the role of an employee. This method can only be accessed by users with ADMIN or
   * MANAGER roles.
   *
  ...
  /**
   * Updates the salary of an employee. This method can only be accessed by users with ADMIN or
   * MANAGER roles.
   *
   * @param id the ID of the employee
  ...
  /**
   * Deactivates an employee account. This method can only be accessed by users with ADMIN or
   * MANAGER roles.
   *
  ...
  /**
   * Reactivates an employee account. This method can only be accessed by users with ADMIN or
   * MANAGER roles.
   *
  ...
  /**
   * Updates the work schedule for an employee. This method can only be accessed by users with ADMIN
   * or MANAGER roles.
   *
   * @param id the ID of the employee
  ...
  /**
   * Sets the emergency availability status for an employee. This method can only be accessed by
   * users with ADMIN or MANAGER roles.
   *
   * @param id the ID of the employee
   ...
   */
  @Override
  public Page<Employee> getEmployeesByHireDateBetween(
  ...
  /**
   * Updates the active status of an employee. This method is used for both deactivating and
