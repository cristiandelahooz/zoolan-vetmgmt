...
public class ProductForm extends Dialog {
    ...
    public ProductForm(ProductService productService, SupplierService supplierService, WarehouseService warehouseService) {
    ...
    private void createForm() {
        ...
        productInfo.add(name, description, purchasePrice, salesPrice, accountingStock, availableStock, reorderLevel, category, supplier, warehouse);
        productInfo.setResponsiveSteps(new FormLayout.ResponsiveStep("0", 1),
