...
public class DashboardView extends VerticalLayout {
    ...
    public DashboardView() {
        ...
        verticallayout.addClassNames(LumoUtility.Gap.XSMALL);
        verticallayout.getElement().getThemeList().add("spacing");
        Span caption = new Span("Caption");
        caption.addClassNames(LumoUtility.FontSize.XSMALL);
        verticallayout.add(caption);
        Div div12 = new Div();
        Div div13 = new Div();
        div12.add(div13);
        Span first = new Span("First:");
        first.addClassNames(LumoUtility.FontSize.XSMALL);
        div12.add(first);
        Span value = new Span("Value");
        div12.add(value);
        verticallayout.add(div12);
        Div div14 = new Div();
        Div div15 = new Div();
        div14.add(div15);
        Span second = new Span("Second:");
        second.addClassNames(LumoUtility.FontSize.XSMALL);
        div14.add(second);
        Span value2 = new Span("Value");
        div14.add(value2);
        verticallayout.add(div14);
        Div div16 = new Div();
        Div div17 = new Div();
        div16.add(div17);
        Span third = new Span("Third:");
        third.addClassNames(LumoUtility.FontSize.XSMALL);
        div16.add(third);
        Span value3 = new Span("Value");
        div16.add(value3);
        verticallayout.add(div16);
        Div div18 = new Div();
        Div div19 = new Div();
        div18.add(div19);
        Span fourth = new Span("Fourth:");
        fourth.addClassNames(LumoUtility.FontSize.XSMALL);
        div18.add(fourth);
        Span value4 = new Span("Value");
        div18.add(value4);
        verticallayout.add(div18);
        div8.add(verticallayout);
        div3.add(div8);
