...
public class WaitingRoomForm extends Dialog {
  ...
  private final com.vaadin.flow.component.datetimepicker.DateTimePicker arrivalTimeField =
      new DateTimePicker("Hora de Llegada");
  ...
  public WaitingRoomForm(
    ...
    FormLayout formLayout =
        new FormLayout(
            clientField, petField, reasonField, priorityField, notesField, arrivalTimeField);
