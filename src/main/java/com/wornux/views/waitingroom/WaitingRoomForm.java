...
public class WaitingRoomForm extends Dialog {
  ...
  private final Binder<WaitingRoomFormModel> binder =
      new BeanValidationBinder<>(WaitingRoomFormModel.class);
  ...
  private void createForm() {
    ...
    formLayout.add(
        clientName, selectClientButton, petComboBox, reasonForVisit, priorityComboBox, notes);
    ...
    VerticalLayout content =
        new VerticalLayout(new H3("Registro en Sala de Espera"), formLayout, buttons);
  ...
  private void setupValidation() {
    ...
    binder
        .forField(priorityComboBox)
        .asRequired("La prioridad es requerida")
        .bind(WaitingRoomFormModel::getPriority, WaitingRoomFormModel::setPriority);

    binder.forField(notes).bind(WaitingRoomFormModel::getNotes, WaitingRoomFormModel::setNotes);
  }
