...
public class PetForm extends Dialog {
  ...
  private final Binder<PetCreateRequestDto> binder =
      new BeanValidationBinder<>(PetCreateRequestDto.class);
  ...
  private void createForm() {
    ...
    VerticalLayout content =
        new VerticalLayout(
            new H3("Información de la Mascota"), layout, new H3("Dueño"), ownerLayout);
  ...
  private void setupValidation() {
    ...
    binder
        .forField(birthDate)
        .bind(PetCreateRequestDto::getBirthDate, PetCreateRequestDto::setBirthDate);
