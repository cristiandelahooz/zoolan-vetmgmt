...
public class ClientForm extends Div {
    ...
    private void archive(ClickEvent<Button> buttonClickEvent) {
        ...
        ConfirmDialog dialog = new ConfirmationDialogBuilder().withHeader("Archive Client Confirmation")
                .withText("Would you like to archive and disable <<%s>>?".formatted(element.getFirstName()))
                .withCancelText("No").withConfirmText("Yes, archive").withIcon(VaadinIcon.QUESTION_CIRCLE_O)
                .onConfirm(event -> {
