...
public class SupplierForm extends Dialog {
  ...
  private final Binder<SupplierCreateRequestDto> binder =
      new BeanValidationBinder<>(SupplierCreateRequestDto.class);
  ...
  private void createForm() {
    ...
    VerticalLayout content =
        new VerticalLayout(new H3("Información del Proveedor"), formLayout, buttons);
  ...
  private void setupValidation() {
    binder
        .forField(rnc)
        .asRequired("RNC requerido")
        .bind(SupplierCreateRequestDto::getRnc, SupplierCreateRequestDto::setRnc);
    binder
        .forField(companyName)
        .asRequired("Nombre requerido")
        .bind(SupplierCreateRequestDto::getCompanyName, SupplierCreateRequestDto::setCompanyName);
    binder
        .forField(contactPerson)
        .bind(
            SupplierCreateRequestDto::getContactPerson, SupplierCreateRequestDto::setContactPerson);
    binder
        .forField(contactPhone)
        .bind(SupplierCreateRequestDto::getContactPhone, SupplierCreateRequestDto::setContactPhone);
    binder
        .forField(contactEmail)
        .bind(SupplierCreateRequestDto::getContactEmail, SupplierCreateRequestDto::setContactEmail);
    binder
        .forField(province)
        .bind(SupplierCreateRequestDto::getProvince, SupplierCreateRequestDto::setProvince);
    binder
        .forField(municipality)
        .bind(SupplierCreateRequestDto::getMunicipality, SupplierCreateRequestDto::setMunicipality);
    binder
        .forField(sector)
        .bind(SupplierCreateRequestDto::getSector, SupplierCreateRequestDto::setSector);
    binder
        .forField(streetAddress)
        .bind(
            SupplierCreateRequestDto::getStreetAddress, SupplierCreateRequestDto::setStreetAddress);
  }
