...
public class WarehouseView extends VerticalLayout {
  ...
  public WarehouseView(
    ...
    this.warehouseGrid =
        new WarehouseGrid(warehouseDataProvider, this::editWarehouse, this::deleteWarehouse);
  ...
  private void setupLayout() {
    ...
    contentLayout.add(
        toggleGridButton, gridFilters, warehouseGrid, createFormLayout(), createFooterBar());
  ...
  private void setupComponents() {
    ...
    toggleGridButton.addClickListener(
        e -> {
  ...
  private FormLayout createFormLayout() {
    ...
    formLayout.add(
        new H3("Información del Almacén"), name, warehouseType, availableForSale, status);
  ...
  private void applyFilters() {
    ...
    warehouseDataProvider.setFilter(
        warehouse -> {
          ...
          boolean matchesStatus =
              "Todos".equals(status)
                  ...
                  || ("Inactivo".equals(status) && !warehouse.isStatus());
