...
public class WarehouseGrid extends Grid<Warehouse> {
  public WarehouseGrid(
      ListDataProvider<Warehouse> dataProvider,
      Consumer<Warehouse> onEdit,
