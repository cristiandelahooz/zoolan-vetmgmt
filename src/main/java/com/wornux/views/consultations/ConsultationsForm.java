...
public class ConsultationsForm extends Dialog {
  ...
  private void createForm() {
    ...
    formLayout.add(
        ...
        consultationDate,
        consultationTime,
        selectVeterinarianButton,
        selectedVeterinarianField,
        selectPetButton,
        selectedPetField);
    ...
    List<String> timeSlots =
        IntStream.rangeClosed(8 * 60, 20 * 60)
            .filter(min -> min % 15 == 0)
  ...
  private void openVeterinarianDialog() {
    ...
    grid.addColumn(e -> e.getEmployeeRole() != null ? e.getEmployeeRole().name() : "")
        .setHeader("Rol")
        .setKey("role");
  ...
  private void save(ClickEvent<Button> event) {
    ...
    if (editingConsultation == null) {
      CreateConsultationRequestDto dto =
          CreateConsultationRequestDto.builder()
      ...
      UpdateConsultationRequestDto dto =
          UpdateConsultationRequestDto.builder()
              .notes(notes.getValue())
              .diagnosis(diagnosis.getValue())
              .treatment(treatment.getValue())
              .prescription(prescription.getValue())
  ...
  public void openForEdit(Consultation consultation) {
    ...
    veterinarianId.setValue(
        consultation.getVeterinarian() != null
            ? consultation.getVeterinarian().getId().toString()
            : "");
