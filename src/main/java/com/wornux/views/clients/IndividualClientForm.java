...
public class IndividualClientForm extends Dialog {
    ...
    // Contact Information
    private final ComboBox<PreferredContactMethod> preferredContactMethod = new ComboBox<>("Método de Contacto Preferido");
    ...
    private void createForm() {
        ...
        contactInfo.add(
            preferredContactMethod, emergencyContactName, emergencyContactNumber
        );
    ...
    private void setupValidation() {
        ...
        binder.forField(birthDate)
            .bind(ClientCreateRequestDto::birthDate, null);
            
        binder.forField(gender)
            .bind(ClientCreateRequestDto::gender, null);
        ...
        binder.forField(cedula)
            .bind(ClientCreateRequestDto::cedula, null);
            
        binder.forField(passport)
            .bind(ClientCreateRequestDto::passport, null);
        ...
        binder.forField(emergencyContactName)
            .bind(ClientCreateRequestDto::emergencyContactName, null);
            
        binder.forField(emergencyContactNumber)
            .bind(ClientCreateRequestDto::emergencyContactNumber, null);
            
        binder.forField(rating)
            .bind(ClientCreateRequestDto::rating, null);
            
        binder.forField(referenceSource)
            .bind(ClientCreateRequestDto::referenceSource, null);
        ...
        binder.forField(referencePoints)
            .bind(ClientCreateRequestDto::referencePoints, null);
            
        binder.forField(notes)
            .bind(ClientCreateRequestDto::notes, null);
    }
