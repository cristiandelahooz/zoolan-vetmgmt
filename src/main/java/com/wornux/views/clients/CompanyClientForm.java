...
public class CompanyClientForm extends Dialog {
    ...
    private void createForm() {
        ...
        companyInfo.setResponsiveSteps(new FormLayout.ResponsiveStep("0", 1),
        ...
        businessInfo.setResponsiveSteps(new FormLayout.ResponsiveStep("0", 1),
                new FormLayout.ResponsiveStep("500px", 2));
    ...
    private void setupValidation() {
        binder.forField(companyName).asRequired("El nombre de la empresa es requerido")
    ...
    private void save(ClickEvent<Button> event) {
        try {
            ...
            ClientCreateRequestDto dto = new ClientCreateRequestDto(email.getValue(), null, // firstName is null for companies
                    ...
                    rncValue, companyName.getValue(), preferredContactMethod.getValue(),
                    emergencyContactName.getValue(), emergencyContactNumber.getValue(), rating.getValue(),
                    creditLimit.getValue(), paymentTermsDays.getValue().intValue(), notes.getValue(),
