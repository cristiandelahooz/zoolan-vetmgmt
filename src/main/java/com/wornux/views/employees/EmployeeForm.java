...
public class EmployeeForm extends Dialog {
    ...
    private final Binder<EmployeeCreateRequestDto> binder = new BeanValidationBinder<>(EmployeeCreateRequestDto.class);
    ...
    private void createForm() {
        ...
        userInfo.add(username, password, firstName, lastName, email, phoneNumber, birthDate, gender, nationality);
        userInfo.setResponsiveSteps(new FormLayout.ResponsiveStep("0", 1),
        ...
        employeeInfo.setResponsiveSteps(new FormLayout.ResponsiveStep("0", 1),
                new FormLayout.ResponsiveStep(RESPONSIVE_STEP_WIDTH, 2));

        FormLayout emergencyInfo = new FormLayout();
        emergencyInfo.add(emergencyContactName, emergencyContactPhone);
        emergencyInfo.setResponsiveSteps(new FormLayout.ResponsiveStep("0", 1),
                new FormLayout.ResponsiveStep(RESPONSIVE_STEP_WIDTH, 2));
        ...
        content.add(new H3("Información del Usuario"), userInfo, new H3("Dirección"), addressInfo,
                new H3("Información del Empleado"), employeeInfo, new H3("Contacto de Emergencia"), emergencyInfo);
    ...
    private void setupValidation() {
        ...
        username.setErrorMessage("El nombre de usario es requerido y debe tener entre " + MIN_USERNAME_LENGTH + " y "
    ...
    private boolean validateForm() {
        ...
        if (username.isEmpty() || username.getValue().length() < MIN_USERNAME_LENGTH
     ...
     * 
     * @param listener
     *            Consumer that receives the saved employee DTO
     */
