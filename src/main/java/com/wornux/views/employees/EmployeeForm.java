...
public class EmployeeForm extends Dialog {
    ...
    private void createForm() {
        ...
        userInfo.add(
            username, password, firstName, lastName, email, phoneNumber, birthDate, gender, nationality
        );
        ...
        employeeInfo.add(
            employeeRole, salary, hireDate, workSchedule
        );
    ...
    private void setupValidation() {
        ...
        username.setErrorMessage("El nombre de usario es requerido y debe tener entre " + MIN_USERNAME_LENGTH + " y " + MAX_USERNAME_LENGTH + " caracteres");
        
        password.setRequired(true);
        password.setRequiredIndicatorVisible(true);
        password.setMinLength(MIN_PASSWORD_LENGTH);
        password.setErrorMessage("La contraseña es requerida y debe tener al menos " + MIN_PASSWORD_LENGTH + " caracteres");
    ...
    private boolean validateForm() {
        ...
        if (username.isEmpty() || username.getValue().length() < MIN_USERNAME_LENGTH || username.getValue().length() > MAX_USERNAME_LENGTH) {
