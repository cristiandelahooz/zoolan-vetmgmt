...
@Mapper(
    ...
    uses = AppointmentMapperHelper.class)
public interface AppointmentMapper {
  ...
  @Mapping(
      target = "assignedEmployee",
      source = "dto.assignedEmployeeId",
      qualifiedByName = "mapEmployee")
  ...
  void updateAppointmentFromDTO(
      AppointmentUpdateRequestDto dto, @MappingTarget Appointment appointment);
  ...
  @Mapping(
      ...
      expression = "java(appointment.getEmployeeDisplayName())")
  @Mapping(
      target = "startAppointmentDate",
      expression = "java(appointment.getStartAppointmentDate())")
