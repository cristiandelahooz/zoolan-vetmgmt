...
public record ClientCreateRequestDto(@Email(message = "Please provide a valid email address") String email,
                                     ...
                                     @Pattern(regexp = DOMINICAN_PHONE_PATTERN_OPTIONAL, message = "Proporcione un número de emergencia válido") @Nullable String emergencyContactNumber,
