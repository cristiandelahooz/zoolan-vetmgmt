...
/**
 * Interface for objects that can be validated for pet breed compatibility. Any class that has both
 * a PetType and a breed String can implement this interface to be validated using
 * the @ValidPetBreed annotation.
 */
