package com.wornux.features.client.service.dto;
...
import static com.wornux.common.constants.ValidationConstants.*;

public record ClientCreateDTO(@Email(message = "Please provide a valid email address") String email, String firstName,
        String lastName,
        ...
        @Nullable Gender gender, String nationality,
        ...
        @Nullable String companyName, PreferredContactMethod preferredContactMethod,
        ...
        @Nullable ReferenceSource referenceSource, @NotBlank(message = "La provincia es requerida") String province,
