...
public class MenuBarHandler {
  ...
  private static final String SELECTED_MENU_ITEM_TEXT_COLOR =
   ...
   * @param component The component to display when the menu item is selected.
   */
   ...
   *
   * @param defaultMenuItem The menu item to select by default.
   */
