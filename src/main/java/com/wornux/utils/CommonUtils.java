...
public final class CommonUtils {
  ...
  public static void commentsFormat(TextArea comments, int charLimit) {
    ...
    comments.addValueChangeListener(
  ...
  public static <C> ComboBox.ItemFilter<C> comboBoxItemFilter(
      Function<C, String> propertyExtractor, BiPredicate<String, String> filterLogic) {
    return (item, filterText) ->
        filterLogic.test(normalizeText(propertyExtractor.apply(item)), normalizeText(filterText));
  }
  ...
  public static <T> Renderer<T> disabledRenderer(ValueProvider<T, Boolean> provider) {
    return LitRenderer.<T>of(
        ...
        .withProperty("icon", value -> provider.apply(value) ? "check" : "minus")
        .withProperty(
            "color",
            value ->
  ...
  public static <T> List<Long> createFilteredDisplacement(
      Specification<T> specification, Class<T> tClass, EntityManager entityManager, String field) {
  ...
  public static MenuItem createIconItem(
      HasMenuItems menu, Component icon, String label, boolean isChild) {
