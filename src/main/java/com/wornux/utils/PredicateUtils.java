...
public final class PredicateUtils {
  ...
  public static <T> Predicate predicateLike(
      Root<T> root, CriteriaBuilder builder, String field, String filter) {
    return builder.like(builder.lower(root.get(field)), "%" + normalizeText(filter) + "%");
  }

  public static Predicate predicateUnaccentLike(
      CriteriaBuilder builder, Path<?> path, String field, String search) {
    return builder.like(
  ...
  public static <T> Predicate predicateUnaccentLike(
    ...
    return builder.like(
        builder.function("unaccent", String.class, builder.lower(root.get(field))),
  ...
  public static Predicate createPredicateForOptionalValue(
      Optional<?> optional,
  ...
  public static Predicate createPredicateForSelectedItemsMandatory(
      Optional<Collection<?>> selectedItems,
      Function<Collection<?>, Predicate> predicateFunction,
      CriteriaBuilder builder) {
    return selectedItems
  ...
  public static Predicate createPredicateForCheckBox(
      Optional<Boolean> checkBoxValue,
      Function<Boolean, Predicate> predicateFunction,
      CriteriaBuilder builder) {
  ...
  public static Predicate createPredicateForInstantRange(
      LocalDate initDate,
      LocalDate endDate,
      Path<Instant> pathGreater,
      Path<Instant> pathLess,
      CriteriaBuilder builder,
      String timeZone) {
    if (initDate != null && endDate != null) {
      ...
      return builder.and(
          builder.greaterThanOrEqualTo(pathGreater, startInstant),
          builder.lessThanOrEqualTo(pathLess, endInstant));
    }
    return builder.conjunction();
  }
  ...
  public static Predicate createPredicateForDateRange(
      LocalDate initDate,
      LocalDate endDate,
      Path<LocalDate> pathGreater,
      Path<LocalDate> pathLess,
      CriteriaBuilder builder) {
    if (initDate != null && endDate != null) {
      return builder.and(
          builder.greaterThanOrEqualTo(pathGreater, initDate),
          builder.lessThanOrEqualTo(pathLess, endDate));
    }
    return builder.conjunction();
  }

  public static <T> void configureMultiSelectComboBox(
      MultiSelectComboBox<T> comboBox,
      ItemLabelGenerator<T> labelGenerator,
      HasValue.ValueChangeListener<
              ? super AbstractField.ComponentValueChangeEvent<MultiSelectComboBox<T>, Set<T>>>
          valueChangeListener) {
  ...
  public static <T> void configureSingleSelectComboBox(
      ComboBox<T> comboBox,
      ItemLabelGenerator<T> labelGenerator,
      HasValue.ValueChangeListener<? super AbstractField.ComponentValueChangeEvent<ComboBox<T>, T>>
          valueChangeListener) {
    comboBox.addClassNames(LumoUtility.Padding.Right.SMALL, LumoUtility.Padding.Top.NONE);
    comboBox.setItemLabelGenerator(labelGenerator);
    comboBox.setClearButtonVisible(true);
  ...
  public static void configureDateFilters(DatePicker initDate, DatePicker endDate, Grid<?> grid) {
    ...
    initDate.addValueChangeListener(
        e -> {
