...
public class InvoiceReportService {
    ...
    public ReportServiceDatabase prepareInvoiceReport(Invoice invoice) {
        ...
        return reportService.withProductsData(reportDto.getProductsData()).put("invoiceId", String.valueOf(reportDto
                .getInvoiceId())).put("invoiceDate", reportDto.getInvoiceDate() != null ? reportDto.getInvoiceDate()
                        .format(DATE_FORMAT) : "").put("clientEmail", reportDto.getClientEmail() != null ? reportDto
                                .getClientEmail() : "").put("clientName", reportDto.getClientName() != null ? reportDto
                                        .getClientName() : "").put("clientAddress", reportDto
                                                .getClientAddress() != null ? reportDto.getClientAddress() : "").put(
                                                        "totalInvoice", reportDto.getTotalAmount() != null ? reportDto
                                                                .getTotalAmount() : "0.00").put("subtotal", reportDto
                                                                        .getSubtotal() != null ? reportDto
                                                                                .getSubtotal() : "0.00").put("tax",
                                                                                        reportDto
                                                                                                .getTax() != null ? reportDto
                                                                                                        .getTax() : "0.00")
    ...
    public byte[] generateInvoicePdf(Invoice invoice) {
        ...
        try {
            ...
            log.info("PDF generado exitosamente para factura #{}, tamaño: {} bytes", invoice.getCode(), pdfData.length);
