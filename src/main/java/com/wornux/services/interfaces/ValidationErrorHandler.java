...
/**
 * Central service for handling validation errors across the application.
 * Provides consistent error handling with context-aware customization.
 * 
 * <p>This service follows the strategy pattern to allow different error handling
 * strategies based on the UI context while maintaining consistency in error processing
 * and user message formatting.</p>
 * 
...
public interface ValidationErrorHandler {
   ...
   */
  void handleValidationErrors(ConstraintViolationException exception, ValidationErrorContext context);
