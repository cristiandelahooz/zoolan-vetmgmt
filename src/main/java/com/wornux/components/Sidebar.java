...
public class Sidebar extends Section implements HasEnabled, HasTheme {
    ...
    @Getter
    private final Button cancel = new Button("Discard");
    @Getter
    private final Button delete = new Button("Delete");

    public Sidebar() {
        addClassNames(LumoUtility.Background.BASE, LumoUtility.BoxShadow.MEDIUM, LumoUtility.Display.FLEX,
                LumoUtility.FlexDirection.COLUMN, LumoUtility.Overflow.HIDDEN, LumoUtility.Position.FIXED, "bottom-0",
                "top-0", "transition-all", "z-10");
        ...
        content.addClassNames(LumoUtility.Display.FLEX, LumoUtility.FlexDirection.COLUMN, LumoUtility.Flex.GROW,
                LumoUtility.Padding.Bottom.MEDIUM, SLIDER_RESPONSIVE_CONTENT);
    ...
    private Footer createFooter() {
        ...
        footer.addClassNames(LumoUtility.Background.CONTRAST_5, LumoUtility.Display.FLEX, LumoUtility.Gap.SMALL,
                LumoUtility.JustifyContent.END, LumoUtility.Padding.Horizontal.MEDIUM,
