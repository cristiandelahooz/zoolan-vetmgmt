...
public class MiniCalendar extends CustomField<LocalDate>
  ...
  private final List<MiniCalendarVariant> appliedVariants =
      new ArrayList<>(MiniCalendarVariant.values().length);
  private final YearMonthHolder yearMonthHolder = new YearMonthHolder();
  private DayOfWeek firstDayOfWeek = getFirstDayOfWeekByLocale(Locale.of("us", "US"));
  ...
  public Registration addYearMonthChangeListener(
      ValueChangeListener<ValueChangeEvent<YearMonth>> listener) {
  ...
  public Registration setDayStyleProvider(
  ...
  private void renderTitle() {
    ...
    previousMonthButton.addClassNames(LumoUtility.Width.AUTO);
    ...
    nextMonthButton.addClassNames(LumoUtility.Width.AUTO);
        ...
        new Span(
            StringUtils.capitalize(
                yearMonthHolder
                    .getValue()
                    .getMonth()
                    .getDisplayName(monthTextStyle, Locale.of("us", "US"))));
  ...
  private void renderHeaderRow() {
    ...
    do {
      Span weekDay =
          span(
              StringUtils.capitalize(
                  _firstDayOfWeek.getDisplayName(dayTextStyle, Locale.of("us", "US"))));
  ...
  private void renderDayRows() {
    ...
    for (int dayOfMonth = 1;
        dayOfMonth <= getLastDayOfMonth(yearMonthHolder.getValue());
        dayOfMonth++) {
  ...
  private Component monthSelect() {
    ...
    monthSelect.setItemLabelGenerator(
        month ->
            StringUtils.capitalize(month.getDisplayName(monthTextStyle, Locale.of("us", "US"))));
    ...
    monthSelect.addValueChangeListener(
        event ->
            yearMonthHolder.setValueFromClient(
  ...
  private Component yearSelection() {
    ...
    yearSelect.addCustomValueSetListener(
        event -> {
  ...
  private Component createDayComponent(LocalDate forDay) {
    ...
    if (dayStyleProvider != null) {
      ...
      if (additionalClassNames != null) {
        additionalClassNames.forEach(
            additionalClassName -> {
              if (StringUtils.hasText(additionalClassName)) {
  ...
  private static final class YearMonthHolder
      implements HasValue<ValueChangeEvent<YearMonth>, YearMonth> {

    private final HasValue<?, YearMonth> instance = this;
    private final List<ValueChangeListener<? super ValueChangeEvent<YearMonth>>>
    ...
    public Registration addValueChangeListener(
        ValueChangeListener<? super ValueChangeEvent<YearMonth>> valueChangeListener) {
      valueChangeListeners.add(valueChangeListener);
      return () -> valueChangeListeners.remove(valueChangeListener);
    }

    private void fireYearMonthValueChangeEvent(
        YearMonth oldValue, YearMonth newValue, boolean fromClient) {
      ...
      final var event =
          new ValueChangeEvent<YearMonth>() {
            @Override
