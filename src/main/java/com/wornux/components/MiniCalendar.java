...
public class MiniCalendar extends CustomField<LocalDate> implements HasThemeVariant<MiniCalendarVariant>,
    ...
    private void renderTitle() {
        ...
        monthTitle = new Span(StringUtils.capitalize(yearMonthHolder.getValue().getMonth().getDisplayName(
                monthTextStyle, Locale.of("us", "US"))));
    ...
    private void renderHeaderRow() {
        ...
        do {
            Span weekDay = span(StringUtils.capitalize(_firstDayOfWeek.getDisplayName(dayTextStyle, Locale.of("us",
                    "US"))));
    ...
    private Component monthSelect() {
        ...
        monthSelect.setItemLabelGenerator(month -> StringUtils.capitalize(month.getDisplayName(monthTextStyle, Locale
                .of("us", "US"))));
        ...
        monthSelect.getStyle().set("--vaadin-combo-box-overlay-width", "10rem").set(
                "--vaadin-combo-box-overlay-max-height", "8rem");

        monthSelect.addValueChangeListener(event -> yearMonthHolder.setValueFromClient(Year.of(yearMonthHolder
                .getValue().getYear()).atMonth(event.getValue())));
    ...
    private Component yearSelection() {
        ...
        yearSelect.getStyle().set("--vaadin-combo-box-overlay-width", "8rem").set(
                "--vaadin-combo-box-overlay-max-height", "8rem");
        ...
        yearSelect.addValueChangeListener(event -> yearMonthHolder.setValueFromClient(event.getValue().atMonth(
                yearMonthHolder.getValue().getMonth())));
