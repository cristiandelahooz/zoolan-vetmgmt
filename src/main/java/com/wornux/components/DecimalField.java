...
@Tag("decimal-field")
public class DecimalField extends CustomField<Double> implements HasValidation, HasClearButton, HasEnabled {
    ...
    public DecimalField(String label) {
        ...
        field.addBlurListener(event -> {
            String value = field.getValue() != null && !field.getValue().isEmpty() ? field.getValue() : "0";
