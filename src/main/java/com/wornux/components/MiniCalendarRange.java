...
public class MiniCalendarRange extends CustomField<DateRange> implements HasThemeVariant<MiniCalendarVariant>,
    ...
    private void renderHeader() {
        ...
        Span monthTitle = new Span(yearMonthHolder.getValue().getMonth().getDisplayName(TextStyle.FULL, getLocale()));
        Span yearTitle = new Span(String.valueOf(yearMonthHolder.getValue().getYear()));

        HorizontalLayout header = new HorizontalLayout(previousMonthButton, monthTitle, yearTitle, nextMonthButton);
    ...
    private Component createDayComponent(LocalDate date) {
        ...
        dayComponent.addClickListener(event -> {
    ...
    private static class YearMonthHolder {
        ...
        private final List<ValueChangeListener<? super ValueChangeEvent<YearMonth>>> listeners = new ArrayList<>();
        ...
        public void setValue(YearMonth value) {
            ...
            this.value = value;
            listeners.forEach(listener -> listener.valueChanged(new ValueChangeEvent<>() {
                @Override
        ...
        public Registration addValueChangeListener(ValueChangeListener<? super ValueChangeEvent<YearMonth>> listener) {
