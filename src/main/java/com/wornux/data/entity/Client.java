...
@Entity
@Table(name = "client", uniqueConstraints = { @UniqueConstraint(columnNames = { "cedula" }),
        @UniqueConstraint(columnNames = { "passport" }), @UniqueConstraint(columnNames = { "rnc" }) })
...
public class Client extends User {
    ...
    @Pattern(regexp = DOMINICAN_PHONE_PATTERN_OPTIONAL, message = "Proporcione un número de teléfono de emergencia válido (809, 849 o 829 seguido de 7 dígitos)")
