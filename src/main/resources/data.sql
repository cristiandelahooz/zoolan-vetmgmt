...
-- Data for users table (40 rows)
 ...
 (1, 'john.doe', 'hashed_password_1', 'john.doe@example.com', 'John', 'Doe', '809-222-3333', '1985-01-15', 'MASCULINO', 'Dominican', 'Santo Domingo', 'Distrito Nacional', 'Naco', 'Calle Principal 123', 'Near the park', NULL, TRUE, NOW(), NOW(), 'USER'),
 (2, 'jane.smith', 'hashed_password_2', 'jane.smith@example.com', 'Jane', 'Smith', '809-555-6666', '1990-03-20', 'FEMENINO', 'Dominican', 'Santiago', 'Santiago de los Caballeros', 'Centro', 'Avenida Central 456', 'Next to the bank', NULL, TRUE, NOW(), NOW(), 'USER'),
 (3, 'peter.jones', 'hashed_password_3', 'peter.jones@example.com', 'Peter', 'Jones', '809-888-9999', '1978-07-01', 'MASCULINO', 'Dominican', 'La Vega', 'Concepcion de La Vega', 'La Esmeralda', 'Callejon Sin Nombre 789', 'Behind the church', NULL, TRUE, NOW(), NOW(), 'USER'),
 (4, 'mary.brown', 'hashed_password_4', 'mary.brown@example.com', 'Mary', 'Brown', '809-111-2222', '1995-11-10', 'FEMENINO', 'Dominican', 'Puerto Plata', 'San Felipe de Puerto Plata', 'Costambar', 'Carretera Principal 101', 'Near the beach', NULL, TRUE, NOW(), NOW(), 'USER'),
 (5, 'david.wilson', 'hashed_password_5', 'david.wilson@example.com', 'David', 'Wilson', '809-444-5555', '1982-02-28', 'MASCULINO', 'Dominican', 'San Cristobal', 'San Cristobal', 'Pueblo Nuevo', 'Callejon de la Paz 202', 'Near the school', NULL, TRUE, NOW(), NOW(), 'USER'),
 (6, 'susan.davis', 'hashed_password_6', 'susan.davis@example.com', 'Susan', 'Davis', '829-777-8888', '1998-09-05', 'FEMENINO', 'Dominican', 'La Romana', 'La Romana', 'Villa Hermosa', 'Avenida del Sol 303', 'In front of the market', NULL, TRUE, NOW(), NOW(), 'USER'),
 (7, 'robert.miller', 'hashed_password_7', 'robert.miller@example.com', 'Robert', 'Miller', '829-000-1111', '1975-04-12', 'MASCULINO', 'Dominican', 'Duarte', 'San Francisco de Macoris', 'Los Rieles', 'Callejon de la Luna 404', 'Next to the river', NULL, TRUE, NOW(), NOW(), 'USER'),
 (8, 'linda.garcia', 'hashed_password_8', 'linda.garcia@example.com', 'Linda', 'Garcia', '829-333-4444', '1988-06-18', 'FEMENINO', 'Dominican', 'Espaillat', 'Moca', 'Salitre', 'Carretera Vieja 505', 'Near the farm', NULL, TRUE, NOW(), NOW(), 'USER'),
 (9, 'william.rodriguez', 'hashed_password_9', 'william.rodriguez@example.com', 'William', 'Rodriguez', '829-666-7777', '1993-10-25', 'MASCULINO', 'Dominican', 'Peravia', 'Bani', 'El Fundo', 'Calle Principal 606', 'Near the church', NULL, TRUE, NOW(), NOW(), 'USER'),
