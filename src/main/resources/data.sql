...
-- Data for users table (40 rows)
 ...
 (13, 'charles.gonzalez', 'hashed_password_13', 'charles.gonzalez@example.com', 'Charles', 'Gonzalez', '809-333-3333', '1979-03-03', 'MALE', 'Dominican', 'Samaná', 'Santa Barbara de Samana', 'El Catey', 'Avenida del Sol 1010', 'In front of the hotel', NULL, TRUE, NOW(), NOW(), 'USER'),
 (14, 'nancy.perez', 'hashed_password_14', 'nancy.perez@example.com', 'Nancy', 'Perez', '809-444-4444', '1996-04-04', 'FEMALE', 'Dominican', 'San Juan', 'San Juan de la Maguana', 'Hato Nuevo', 'Callejon de la Paz 1111', 'Near the church', NULL, TRUE, NOW(), NOW(), 'USER'),
 (15, 'thomas.sanchez', 'hashed_password_15', 'thomas.sanchez@example.com', 'Thomas', 'Sanchez', '809-555-5555', '1983-05-05', 'MALE', 'Dominican', 'Valverde', 'Mao', 'Esperanza', 'Calle Principal 1212', 'Next to the park', NULL, TRUE, NOW(), NOW(), 'USER'),
 (16, 'margaret.ramirez', 'hashed_password_16', 'margaret.ramirez@example.com', 'Margaret', 'Ramirez', '829-666-6666', '1991-06-06', 'FEMALE', 'Dominican', 'Hermanas Mirabal', 'Salcedo', 'Tenares', 'Avenida Central 1313', 'Behind the school', NULL, TRUE, NOW(), NOW(), 'USER'),
 (17, 'daniel.cruz', 'hashed_password_17', 'daniel.cruz@example.com', 'Daniel', 'Cruz', '829-777-7777', '1976-07-07', 'MALE', 'Dominican', 'Monte Plata', 'Monte Plata', 'Bayaguana', 'Callejon Sin Nombre 1414', 'Near the river', NULL, TRUE, NOW(), NOW(), 'USER'),
 (18, 'dorothy.morales', 'hashed_password_18', 'dorothy.morales@example.com', 'Dorothy', 'Morales', '829-888-8888', '1994-08-08', 'FEMALE', 'Dominican', 'Hato Mayor', 'Hato Mayor del Rey', 'Sabana de la Mar', 'Carretera Principal 1515', 'Near the farm', NULL, TRUE, NOW(), NOW(), 'USER'),
 (19, 'paul.gomez', 'hashed_password_19', 'paul.gomez@example.com', 'Paul', 'Gomez', '829-999-9999', '1981-09-09', 'MALE', 'Dominican', 'El Seibo', 'Santa Cruz de El Seibo', 'Miches', 'Avenida del Sol 1616', 'In front of the market', NULL, TRUE, NOW(), NOW(), 'USER'),
 (20, 'sandra.diaz', 'hashed_password_20', 'sandra.diaz@example.com', 'Sandra', 'Diaz', '829-000-0000', '1989-10-10', 'FEMALE', 'Dominican', 'Independencia', 'Jimaní', 'Duverge', 'Callejon de la Luna 1717', 'Next to the bank', NULL, TRUE, NOW(), NOW(), 'USER'),
 (21, 'mark.alvarez', 'hashed_password_21', 'mark.alvarez@example.com', 'Mark', 'Alvarez', '849-456-7890', '1984-11-11', 'MALE', 'Dominican', 'Dajabón', 'Dajabon', 'Loma de Cabrera', 'Calle Principal 1818', 'Near the park', NULL, TRUE, NOW(), NOW(), 'USER'),
 (22, 'sharon.ruiz', 'hashed_password_22', 'sharon.ruiz@example.com', 'Sharon', 'Ruiz', '849-654-3210', '1997-12-12', 'FEMALE', 'Dominican', 'Baoruco', 'Neiba', 'Tamayo', 'Avenida Central 1919', 'Next to the school', NULL, TRUE, NOW(), NOW(), 'USER'),
 (23, 'george.torres', 'hashed_password_23', 'george.torres@example.com', 'George', 'Torres', '849-233-4455', '1977-01-13', 'MALE', 'Dominican', 'Elías Piña', 'Comendador', 'Bánica', 'Callejon Sin Nombre 2020', 'Behind the church', NULL, TRUE, NOW(), NOW(), 'USER'),
 (24, 'betty.flores', 'hashed_password_24', 'betty.flores@example.com', 'Betty', 'Flores', '849-677-8899', '1990-02-14', 'FEMALE', 'Dominican', 'San José de Ocoa', 'San Jose de Ocoa', 'Rancho Arriba', 'Carretera Principal 2121', 'Near the river', NULL, TRUE, NOW(), NOW(), 'USER'),
 (25, 'kenneth.rivera', 'hashed_password_25', 'kenneth.rivera@example.com', 'Kenneth', 'Rivera', '849-788-9900', '1986-03-15', 'MALE', 'Dominican', 'Monseñor Nouel', 'Bonao', 'Piedra Blanca', 'Avenida del Sol 2222', 'In front of the market', NULL, TRUE, NOW(), NOW(), 'USER'),
 (26, 'helen.guzman', 'hashed_password_26', 'helen.guzman@example.com', 'Helen', 'Guzman', '849-899-0011', '1999-04-16', 'FEMALE', 'Dominican', 'Hermanas Mirabal', 'Salcedo', 'Villa Tapia', 'Callejon de la Luna 2323', 'Next to the bank', NULL, TRUE, NOW(), NOW(), 'USER'),
 (27, 'steven.pena', 'hashed_password_27', 'steven.pena@example.com', 'Steven', 'Pena', '849-900-1122', '1974-05-17', 'MALE', 'Dominican', 'María Trinidad Sánchez', 'Nagua', 'Cabrera', 'Calle Principal 2424', 'Near the park', NULL, TRUE, NOW(), NOW(), 'USER'),
 (28, 'kimberly.castro', 'hashed_password_28', 'kimberly.castro@example.com', 'Kimberly', 'Castro', '849-011-2233', '1992-06-18', 'FEMALE', 'Dominican', 'Sánchez Ramírez', 'Cotuí', 'Fantino', 'Avenida Central 2525', 'Next to the school', NULL, TRUE, NOW(), NOW(), 'USER'),
 (29, 'edward.rojas', 'hashed_password_29', 'edward.rojas@example.com', 'Edward', 'Rojas', '849-122-3344', '1980-07-19', 'MALE', 'Dominican', 'San Pedro de Macorís', 'San Pedro de Macoris', 'Consuelo', 'Callejon Sin Nombre 2626', 'Behind the church', NULL, TRUE, NOW(), NOW(), 'USER'),
 (30, 'donna.soto', 'hashed_password_30', 'donna.soto@example.com', 'Donna', 'Soto', '849-233-4455', '1987-08-20', 'FEMALE', 'Dominican', 'Santiago Rodríguez', 'San Ignacio de Sabaneta', 'Moncion', 'Carretera Principal 2727', 'Near the river', NULL, TRUE, NOW(), NOW(), 'USER'),
 (31, 'joseph.vargas', 'hashed_password_31', 'joseph.vargas@example.com', 'Joseph', 'Vargas', '849-344-5566', '1985-09-21', 'MALE', 'Dominican', 'Santo Domingo', 'Santo Domingo Norte', 'Villa Mella', 'Avenida del Sol 2828', 'In front of the hotel', NULL, TRUE, NOW(), NOW(), 'USER'),
 (32, 'michelle.reyes', 'hashed_password_32', 'michelle.reyes@example.com', 'Michelle', 'Reyes', '849-455-6677', '1993-10-22', 'FEMALE', 'Dominican', 'Santo Domingo', 'Santo Domingo Oeste', 'Manoguayabo', 'Callejon de la Paz 2929', 'Near the church', NULL, TRUE, NOW(), NOW(), 'USER'),
 (33, 'ryan.mendez', 'hashed_password_33', 'ryan.mendez@example.com', 'Ryan', 'Mendez', '849-566-7788', '1978-11-23', 'MALE', 'Dominican', 'Santo Domingo', 'Santo Domingo Este', 'Los Mina', 'Calle Principal 3030', 'Next to the park', NULL, TRUE, NOW(), NOW(), 'USER'),
 (34, 'jessica.nuñez', 'hashed_password_34', 'jessica.nuñez@example.com', 'Jessica', 'Nuñez', '829-677-8899', '1996-12-24', 'FEMALE', 'Dominican', 'Santo Domingo', 'Boca Chica', 'Andres', 'Avenida Central 3131', 'Behind the school', NULL, TRUE, NOW(), NOW(), 'USER'),
 (35, 'gary.guerrero', 'hashed_password_35', 'gary.guerrero@example.com', 'Gary', 'Guerrero', '829-788-9900', '1982-01-25', 'MALE', 'Dominican', 'Santo Domingo', 'Pedro Brand', 'La Cuaba', 'Callejon Sin Nombre 3232', 'Near the river', NULL, TRUE, NOW(), NOW(), 'USER'),
 (36, 'cynthia.santana', 'hashed_password_36', 'cynthia.santana@example.com', 'Cynthia', 'Santana', '809-899-0011', '1990-02-26', 'FEMALE', 'Dominican', 'Santo Domingo', 'San Antonio de Guerra', 'Hato Viejo', 'Carretera Principal 3333', 'Near the farm', NULL, TRUE, NOW(), NOW(), 'USER'),
 (37, 'larry.castillo', 'hashed_password_37', 'larry.castillo@example.com', 'Larry', 'Castillo', '809-900-1122', '1975-03-27', 'MALE', 'Dominican', 'Santo Domingo', 'Los Alcarrizos', 'Pantoja', 'Avenida del Sol 3434', 'In front of the market', NULL, TRUE, NOW(), NOW(), 'USER'),
 (38, 'angela.herrera', 'hashed_password_38', 'angela.herrera@example.com', 'Angela', 'Herrera', '809-011-2233', '1998-04-28', 'FEMALE', 'Dominican', 'Santo Domingo', 'Santo Domingo Este', 'San Isidro', 'Callejon de la Luna 3535', 'Next to the bank', NULL, TRUE, NOW(), NOW(), 'USER'),
 (39, 'frank.dominguez', 'hashed_password_39', 'frank.dominguez@example.com', 'Frank', 'Dominguez', '849-122-3344', '1981-05-29', 'MALE', 'Dominican', 'Santo Domingo', 'Santo Domingo Norte', 'Sabana Perdida', 'Calle Principal 3636', 'Near the park', NULL, TRUE, NOW(), NOW(), 'USER'),
 (40, 'brenda.vasquez', 'hashed_password_40', 'brenda.vasquez@example.com', 'Brenda', 'Vasquez', '849-233-4455', '1989-06-30', 'FEMALE', 'Dominican', 'Santo Domingo', 'Santo Domingo Oeste', 'Palmarejo', 'Avenida Central 3737', 'Next to the school', NULL, TRUE, NOW(), NOW(), 'USER');
--
