...
INSERT INTO users (user_id, username, password, email, first_name, last_name, phone_number, birth_date,
                   nationality, province, municipality, sector, street_address, reference_points, active, created_at,
                   updated_at, system_role)
VALUES (1, 'john.doe', 'hashed_password_1', 'john.doe@example.com', 'John', 'Doe', '8092223333', '1985-01-15',
        'Dominican', 'Santo Domingo', 'Distrito Nacional', 'Naco', 'Calle Principal 123', 'Near the park',
        TRUE, NOW(), NOW(), 'USER'),
       (2, 'jane.smith', 'hashed_password_2', 'jane.smith@example.com', 'Jane', 'Smith', '8095556666', '1990-03-20',
        'Dominican', 'Santiago', 'Santiago de los Caballeros', 'Centro', 'Avenida Central 456',
        'Next to the bank', TRUE, NOW(), NOW(), 'USER'),
       (3, 'peter.jones', 'hashed_password_3', 'peter.jones@example.com', 'Peter', 'Jones', '8098889999', '1978-07-01',
        'Dominican', 'La Vega', 'Concepcion de La Vega', 'La Esmeralda', 'Callejon Sin Nombre 789',
        'Behind the church', TRUE, NOW(), NOW(), 'USER'),
       (4, 'mary.brown', 'hashed_password_4', 'mary.brown@example.com', 'Mary', 'Brown', '8091112222', '1995-11-10',
        'Dominican', 'Puerto Plata', 'San Felipe de Puerto Plata', 'Costambar', 'Carretera Principal 101',
        'Near the beach', TRUE, NOW(), NOW(), 'USER'),
       (5, 'david.wilson', 'hashed_password_5', 'david.wilson@example.com', 'David', 'Wilson', '8094445555',
        '1982-02-28', 'Dominican', 'San Cristobal', 'San Cristobal', 'Pueblo Nuevo',
        'Callejon de la Paz 202', 'Near the school', TRUE, NOW(), NOW(), 'USER'),
       (6, 'susan.davis', 'hashed_password_6', 'susan.davis@example.com', 'Susan', 'Davis', '8297778888', '1998-09-05',
        'Dominican', 'La Romana', 'La Romana', 'Villa Hermosa', 'Avenida del Sol 303',
        'In front of the market', TRUE, NOW(), NOW(), 'USER'),
       (7, 'robert.miller', 'hashed_password_7', 'robert.miller@example.com', 'Robert', 'Miller', '8290001111',
        '1975-04-12', 'Dominican', 'Duarte', 'San Francisco de Macoris', 'Los Rieles',
        'Callejon de la Luna 404', 'Next to the river', TRUE, NOW(), NOW(), 'USER'),
       (8, 'linda.garcia', 'hashed_password_8', 'linda.garcia@example.com', 'Linda', 'Garcia', '8293334444',
        '1988-06-18', 'Dominican', 'Espaillat', 'Moca', 'Salitre', 'Carretera Vieja 505', 'Near the farm',
        TRUE, NOW(), NOW(), 'USER'),
       (9, 'william.rodriguez', 'hashed_password_9', 'william.rodriguez@example.com', 'William', 'Rodriguez',
        '8296667777', '1993-10-25', 'Dominican', 'Peravia', 'Bani', 'El Fundo', 'Calle Principal 606',
        'Near the church', TRUE, NOW(), NOW(), 'USER'),
       (10, 'patricia.martinez', 'hashed_password_10', 'patricia.martinez@example.com', 'Patricia', 'Martinez',
        '8299990000', '1980-12-30', 'Dominican', 'Azua', 'Azua de Compostela', 'La Bombita',
        'Avenida Central 707', 'Next to the school', TRUE, NOW(), NOW(), 'USER'),
       (11, 'james.hernandez', 'hashed_password_11', 'james.hernandez@example.com', 'James', 'Hernandez',
        '8091111111', '1987-01-01', 'Dominican', 'Barahona', 'Santa Cruz de Barahona', 'Villa Central',
        'Callejon Sin Nombre 808', 'Behind the hospital', TRUE, NOW(), NOW(), 'USER'),
       (12, 'elizabeth.lopez', 'hashed_password_12', 'elizabeth.lopez@example.com', 'Elizabeth', 'Lopez',
        '8092222222', '1992-02-02', 'Dominican', 'Monte Cristi', 'San Fernando de Monte Cristi',
        'Las Matas', 'Carretera Principal 909', 'Near the river', TRUE, NOW(), NOW(), 'USER'),
       (13, 'charles.gonzalez', 'hashed_password_13', 'charles.gonzalez@example.com', 'Charles', 'Gonzalez',
        '8093333333', '1979-03-03', 'Dominican', 'Samaná', 'Santa Barbara de Samana', 'El Catey',
        'Avenida del Sol 1010', 'In front of the hotel', TRUE, NOW(), NOW(), 'USER'),
       (14, 'nancy.perez', 'hashed_password_14', 'nancy.perez@example.com', 'Nancy', 'Perez', '8094444444',
        '1996-04-04', 'Dominican', 'San Juan', 'San Juan de la Maguana', 'Hato Nuevo',
        'Callejon de la Paz 1111', 'Near the church', TRUE, NOW(), NOW(), 'USER'),
       (15, 'thomas.sanchez', 'hashed_password_15', 'thomas.sanchez@example.com', 'Thomas', 'Sanchez', '8095555555',
        '1983-05-05', 'Dominican', 'Valverde', 'Mao', 'Esperanza', 'Calle Principal 1212',
        'Next to the park', TRUE, NOW(), NOW(), 'USER'),
       (16, 'margaret.ramirez', 'hashed_password_16', 'margaret.ramirez@example.com', 'Margaret', 'Ramirez',
        '8296666666', '1991-06-06', 'Dominican', 'Hermanas Mirabal', 'Salcedo', 'Tenares',
        'Avenida Central 1313', 'Behind the school', TRUE, NOW(), NOW(), 'USER'),
       (17, 'daniel.cruz', 'hashed_password_17', 'daniel.cruz@example.com', 'Daniel', 'Cruz', '8297777777',
        '1976-07-07', 'Dominican', 'Monte Plata', 'Monte Plata', 'Bayaguana', 'Callejon Sin Nombre 1414',
        'Near the river', TRUE, NOW(), NOW(), 'USER'),
       (18, 'dorothy.morales', 'hashed_password_18', 'dorothy.morales@example.com', 'Dorothy', 'Morales',
        '8298888888', '1994-08-08', 'Dominican', 'Hato Mayor', 'Hato Mayor del Rey', 'Sabana de la Mar',
        'Carretera Principal 1515', 'Near the farm', TRUE, NOW(), NOW(), 'USER'),
       (19, 'paul.gomez', 'hashed_password_19', 'paul.gomez@example.com', 'Paul', 'Gomez', '8299999999', '1981-09-09',
        'Dominican', 'El Seibo', 'Santa Cruz de El Seibo', 'Miches', 'Avenida del Sol 1616',
        'In front of the market', TRUE, NOW(), NOW(), 'USER'),
       (20, 'sandra.diaz', 'hashed_password_20', 'sandra.diaz@example.com', 'Sandra', 'Diaz', '8290000000',
        '1989-10-10', 'Dominican', 'Independencia', 'Jimaní', 'Duverge', 'Callejon de la Luna 1717',
        'Next to the bank', TRUE, NOW(), NOW(), 'USER'),
       (21, 'mark.alvarez', 'hashed_password_21', 'mark.alvarez@example.com', 'Mark', 'Alvarez', '8494567890',
        '1984-11-11', 'Dominican', 'Dajabón', 'Dajabon', 'Loma de Cabrera', 'Calle Principal 1818',
        'Near the park', TRUE, NOW(), NOW(), 'USER'),
       (22, 'sharon.ruiz', 'hashed_password_22', 'sharon.ruiz@example.com', 'Sharon', 'Ruiz', '8496543210',
        '1997-12-12', 'Dominican', 'Baoruco', 'Neiba', 'Tamayo', 'Avenida Central 1919',
        'Next to the school', TRUE, NOW(), NOW(), 'USER'),
       (23, 'george.torres', 'hashed_password_23', 'george.torres@example.com', 'George', 'Torres', '8492334455',
        '1977-01-13', 'Dominican', 'Elías Piña', 'Comendador', 'Bánica', 'Callejon Sin Nombre 2020',
        'Behind the church', TRUE, NOW(), NOW(), 'USER'),
       (24, 'betty.flores', 'hashed_password_24', 'betty.flores@example.com', 'Betty', 'Flores', '8496778899',
        '1990-02-14', 'Dominican', 'San José de Ocoa', 'San Jose de Ocoa', 'Rancho Arriba',
        'Carretera Principal 2121', 'Near the river', TRUE, NOW(), NOW(), 'USER'),
       (25, 'kenneth.rivera', 'hashed_password_25', 'kenneth.rivera@example.com', 'Kenneth', 'Rivera', '8497889900',
        '1986-03-15', 'Dominican', 'Monseñor Nouel', 'Bonao', 'Piedra Blanca', 'Avenida del Sol 2222',
        'In front of the market', TRUE, NOW(), NOW(), 'USER'),
       (26, 'helen.guzman', 'hashed_password_26', 'helen.guzman@example.com', 'Helen', 'Guzman', '8498990011',
        '1999-04-16', 'Dominican', 'Hermanas Mirabal', 'Salcedo', 'Villa Tapia', 'Callejon de la Luna 2323',
        'Next to the bank', TRUE, NOW(), NOW(), 'USER'),
       (27, 'steven.pena', 'hashed_password_27', 'steven.pena@example.com', 'Steven', 'Pena', '8499001122',
        '1974-05-17', 'Dominican', 'María Trinidad Sánchez', 'Nagua', 'Cabrera', 'Calle Principal 2424',
        'Near the park', TRUE, NOW(), NOW(), 'USER'),
       (28, 'kimberly.castro', 'hashed_password_28', 'kimberly.castro@example.com', 'Kimberly', 'Castro',
        '8490112233', '1992-06-18', 'Dominican', 'Sánchez Ramírez', 'Cotuí', 'Fantino',
        'Avenida Central 2525', 'Next to the school', TRUE, NOW(), NOW(), 'USER'),
       (29, 'edward.rojas', 'hashed_password_29', 'edward.rojas@example.com', 'Edward', 'Rojas', '8491223344',
        '1980-07-19', 'Dominican', 'San Pedro de Macorís', 'San Pedro de Macoris', 'Consuelo',
        'Callejon Sin Nombre 2626', 'Behind the church', TRUE, NOW(), NOW(), 'USER'),
       (30, 'donna.soto', 'hashed_password_30', 'donna.soto@example.com', 'Donna', 'Soto', '8492334455', '1987-08-20',
        'Dominican', 'Santiago Rodríguez', 'San Ignacio de Sabaneta', 'Moncion', 'Carretera Principal 2727',
        'Near the river', TRUE, NOW(), NOW(), 'USER'),
       (31, 'joseph.vargas', 'hashed_password_31', 'joseph.vargas@example.com', 'Joseph', 'Vargas', '8493445566',
        '1985-09-21', 'Dominican', 'Santo Domingo', 'Santo Domingo Norte', 'Villa Mella',
        'Avenida del Sol 2828', 'In front of the hotel', TRUE, NOW(), NOW(), 'USER'),
       (32, 'michelle.reyes', 'hashed_password_32', 'michelle.reyes@example.com', 'Michelle', 'Reyes', '8494556677',
        '1993-10-22', 'Dominican', 'Santo Domingo', 'Santo Domingo Oeste', 'Manoguayabo',
        'Callejon de la Paz 2929', 'Near the church', TRUE, NOW(), NOW(), 'USER'),
       (33, 'ryan.mendez', 'hashed_password_33', 'ryan.mendez@example.com', 'Ryan', 'Mendez', '8495667788',
        '1978-11-23', 'Dominican', 'Santo Domingo', 'Santo Domingo Este', 'Los Mina',
        'Calle Principal 3030', 'Next to the park', TRUE, NOW(), NOW(), 'USER'),
       (34, 'jessica.nuñez', 'hashed_password_34', 'jessica.nuñez@example.com', 'Jessica', 'Nuñez', '8296778899',
        '1996-12-24', 'Dominican', 'Santo Domingo', 'Boca Chica', 'Andres', 'Avenida Central 3131',
        'Behind the school', TRUE, NOW(), NOW(), 'USER'),
       (35, 'gary.guerrero', 'hashed_password_35', 'gary.guerrero@example.com', 'Gary', 'Guerrero', '8297889900',
        '1982-01-25', 'Dominican', 'Santo Domingo', 'Pedro Brand', 'La Cuaba', 'Callejon Sin Nombre 3232',
        'Near the river', TRUE, NOW(), NOW(), 'USER'),
       (36, 'cynthia.santana', 'hashed_password_36', 'cynthia.santana@example.com', 'Cynthia', 'Santana',
        '8098990011', '1990-02-26', 'Dominican', 'Santo Domingo', 'San Antonio de Guerra', 'Hato Viejo',
        'Carretera Principal 3333', 'Near the farm', TRUE, NOW(), NOW(), 'USER'),
       (37, 'larry.castillo', 'hashed_password_37', 'larry.castillo@example.com', 'Larry', 'Castillo', '8099001122',
        '1975-03-27', 'Dominican', 'Santo Domingo', 'Los Alcarrizos', 'Pantoja', 'Avenida del Sol 3434',
        'In front of the market', TRUE, NOW(), NOW(), 'USER'),
       (38, 'angela.herrera', 'hashed_password_38', 'angela.herrera@example.com', 'Angela', 'Herrera', '8090112233',
        '1998-04-28', 'Dominican', 'Santo Domingo', 'Santo Domingo Este', 'San Isidro',
        'Callejon de la Luna 3535', 'Next to the bank', TRUE, NOW(), NOW(), 'USER'),
       (39, 'frank.dominguez', 'hashed_password_39', 'frank.dominguez@example.com', 'Frank', 'Dominguez',
        '8491223344', '1981-05-29', 'Dominican', 'Santo Domingo', 'Santo Domingo Norte',
        'Sabana Perdida', 'Calle Principal 3636', 'Near the park', TRUE, NOW(), NOW(), 'USER'),
       (40, 'brenda.vasquez', 'hashed_password_40', 'brenda.vasquez@example.com', 'Brenda', 'Vasquez', '8492334455',
        '1989-06-30', 'Dominican', 'Santo Domingo', 'Santo Domingo Oeste', 'Palmarejo',
        'Avenida Central 3737', 'Next to the school', TRUE, NOW(), NOW(), 'USER'),
       (41, 'sofia.moreno', 'hashed_password_41', 'sofia.moreno@example.com', 'Sofia', 'Moreno', '8493445566',
        '1992-08-15', 'Dominican', 'Santo Domingo', 'Santo Domingo Este', 'Los Frailes',
        'Calle 123', 'Near the supermarket', TRUE, NOW(), NOW(), 'USER');
--
-- -- Data for employee table (5 rows)
INSERT INTO employee (employee_id, gender, employee_role, salary, hire_date, available, emergency_contact_name,
                      emergency_contact_phone)
VALUES (1,'MASCULINO' , 'VETERINARIAN', 80000.00, '2022-01-15', TRUE, 'Jane Doe', '8092223333'),
       (2, 'MASCULINO','VETERINARIAN', 75000.00, '2023-03-01', TRUE, 'John Smith', '8095556666'),
       (3, 'MASCULINO','RECEPTIONIST', 40000.00, '2023-06-20', TRUE, 'Peter Jones', '8098889999'),
       (4, 'FEMENINO','VETERINARIAN', 78000.00, '2022-10-01', TRUE, 'Alice Brown', '8091112222'),
       (5, 'MASCULINO','RECEPTIONIST', 42000.00, '2024-01-10', TRUE, 'Bob White', '8094445555'),
       (41, 'FEMENINO','GROOMER', 50000.00, '2022-01-15', TRUE, 'Leonela Gonzalez', '8293543720');

-- Data for Employee_Work_Schedule
INSERT INTO employee_work_schedule (id, employee_id, day_of_week, start_time, end_time, is_off_day)
VALUES
    (1, 1, 'MONDAY', '08:30:00', '17:00:00', FALSE),
    (2, 1, 'TUESDAY', '08:30:00', '17:00:00', FALSE),
    (3, 1, 'WEDNESDAY', '08:30:00', '17:00:00', FALSE),
    (4, 1, 'THURSDAY', '08:30:00', '17:00:00', FALSE),
    (5, 1, 'FRIDAY', '08:30:00', '17:00:00', FALSE),
    (6, 1, 'SATURDAY', NULL, NULL, TRUE),
    (7, 1, 'SUNDAY', NULL, NULL, TRUE),
    (8, 2, 'MONDAY', '08:30:00', '17:00:00', FALSE),
    (9, 2, 'TUESDAY', '08:30:00', '17:00:00', FALSE),
    (10, 2, 'WEDNESDAY', '08:30:00', '17:00:00', FALSE),
    (11, 2, 'THURSDAY', '08:30:00', '17:00:00', FALSE),
    (12, 2, 'FRIDAY', '08:30:00', '17:00:00', FALSE),
    (13, 2, 'SATURDAY', NULL, NULL, TRUE),
    (14, 2, 'SUNDAY', NULL, NULL, TRUE),
    (15, 3, 'MONDAY', '08:30:00', '17:00:00', FALSE),
    (16, 3, 'TUESDAY', '08:30:00', '17:00:00', FALSE),
    (17, 3, 'WEDNESDAY', '08:30:00', '17:00:00', FALSE),
    (18, 3, 'THURSDAY', '08:30:00', '17:00:00', FALSE),
    (19, 3, 'FRIDAY', '08:30:00', '17:00:00', FALSE),
    (20, 3, 'SATURDAY', NULL, NULL, TRUE),
    (21, 3, 'SUNDAY', NULL, NULL, TRUE),
    (22, 4, 'MONDAY', '08:30:00', '17:00:00', FALSE),
    (23, 4, 'TUESDAY', '08:30:00', '17:00:00', FALSE),
    (24, 4, 'WEDNESDAY', '08:30:00', '17:00:00', FALSE),
    (25, 4, 'THURSDAY', '08:30:00', '17:00:00', FALSE),
    (26, 4, 'FRIDAY', '08:30:00', '17:00:00', FALSE),
    (27, 4, 'SATURDAY', NULL, NULL, TRUE),
    (28, 4, 'SUNDAY', NULL, NULL, TRUE),
    (29, 5, 'MONDAY', '08:30:00', '17:00:00', FALSE),
    (30, 5, 'TUESDAY', '08:30:00', '17:00:00', FALSE),
    (31, 5, 'WEDNESDAY', '08:30:00', '17:00:00', FALSE),
    (32, 5, 'THURSDAY', '08:30:00', '17:00:00', FALSE),
    (33, 5, 'FRIDAY', '08:30:00', '17:00:00', FALSE),
    (34, 5, 'SATURDAY', NULL, NULL, TRUE),
    (35, 5, 'SUNDAY', NULL, NULL, TRUE),
    (36, 41, 'MONDAY', '08:30:00', '17:00:00', FALSE),
    (37, 41, 'TUESDAY', '08:30:00', '17:00:00', FALSE),
    (38, 41, 'WEDNESDAY', '08:30:00', '17:00:00', FALSE),
    (39, 41, 'THURSDAY', '08:30:00', '17:00:00', FALSE),
    (40, 41, 'FRIDAY', '08:30:00', '17:00:00', FALSE),
    (41, 41, 'SATURDAY', NULL, NULL, TRUE),
    (42, 41, 'SUNDAY', NULL, NULL, TRUE);
...
-- Data for warehouses
INSERT INTO warehouses (id, name, warehouse_type, status, available_for_sale)
VALUES (1, 'Main Warehouse', 'PRINCIPAL', TRUE, TRUE),
...
VALUES (1, 'Premium Dog Food', 'High-quality dry food for adult dogs', TRUE, 1200.00, 1500.00, 100, 80, 20, 'CAJA',
        'VENTA', 1, 'ALIMENTO', 1),
       (2, 'High Protein Cat Food', 'Nutritious wet food for cats', TRUE, 900.00, 1200.00, 200, 180, 30, 'CAJA',
        'VENTA', 1, 'ALIMENTO', 1),
       (3, 'Healthy Dog Treats', 'Natural training treats for dogs', TRUE, 350.00, 500.00, 300, 250, 50, 'UNIDAD',
        'VENTA', 2, 'ALIMENTO', 2),
       (4, 'Crunchy Cat Treats', 'Dental health treats for cats', TRUE, 250.00, 400.00, 250, 200, 40, 'UNIDAD', 'VENTA',
        2, 'ALIMENTO', 2),
       (5, 'Gentle Dog Shampoo', 'Hypoallergenic shampoo for sensitive skin', TRUE, 500.00, 800.00, 150, 120, 25,
        'UNIDAD', 'VENTA', 3, 'HIGIENE', 3),
       (6, 'Soothing Cat Shampoo', 'Moisturizing shampoo for cats', TRUE, 400.00, 700.00, 180, 150, 30, 'UNIDAD',
        'VENTA', 3, 'HIGIENE', 3),
       (7, 'Durable Dog Collar', 'Adjustable nylon collar for medium dogs', TRUE, 350.00, 600.00, 120, 100, 20,
        'UNIDAD', 'VENTA', 4, 'ACCESORIO', 4),
       (8, 'Stylish Cat Collar', 'Decorative collar with bell for cats', TRUE, 300.00, 550.00, 130, 110, 25, 'UNIDAD',
        'VENTA', 4, 'ACCESORIO', 4),
       (9, 'Strong Dog Leash', 'Retractable leash for large dogs', TRUE, 600.00, 900.00, 110, 90, 15, 'UNIDAD', 'VENTA',
        5, 'ACCESORIO', 5),
       (10, 'Clumping Cat Litter', 'Odor-control clumping litter', TRUE, 200.00, 300.00, 400, 350, 60, 'CAJA', 'VENTA',
        5, 'HIGIENE', 5),
       (11, 'Antibiotic Tablets', 'Broad-spectrum antibiotics for pets', TRUE, 1800.00, 2500.00, 50, 40, 10, 'DOCENA',
        'PRIVADO', 1, 'MEDICINA', 1),
       (12, 'Flea Treatment', 'Monthly flea prevention for dogs and cats', TRUE, 1200.00, 1800.00, 75, 60, 15, 'DOCENA',
        'AMBOS', 2, 'MEDICINA', 2),
       (13, 'Pet Vitamins', 'Daily multivitamin supplements', TRUE, 800.00, 1200.00, 100, 80, 20, 'DOCENA', 'AMBOS', 3,
        'MEDICINA', 3),
       (14, 'Dental Chews', 'Tartar control chews for dogs', TRUE, 400.00, 650.00, 200, 170, 35, 'UNIDAD', 'VENTA', 4,
        'HIGIENE', 4),
       (15, 'Pet Carrier', 'Airline-approved pet travel carrier', TRUE, 2500.00, 3500.00, 25, 20, 5, 'UNIDAD', 'VENTA',
        5, 'ACCESORIO', 5);
